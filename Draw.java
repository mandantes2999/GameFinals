...
public class Draw extends JComponent{
	...
	public void reloadImage1(){
		...
		if(state == 0){
			resource = getClass().getResource("runs0.png");
			y= 450;
		}
		else if(state == 1){
			resource = getClass().getResource("runs1.png");
			y= 450;
		}
		else if(state == 2){
			resource = getClass().getResource("runs2.png");
			y= 450;
		}
		else if(state == 3){
			resource = getClass().getResource("runs3.png");
			y= 450;
		}
		else if(state == 4){
			resource = getClass().getResource("runs4.png");
			y= 450;
		}
		else if(state == 5){
			resource = getClass().getResource("runs5.png");
			y= 450;
			state = 0;
		}
				...
				for(int ctr = 0; ctr < 4; ctr++){
					try {
						if(ctr==3){
							...
							resource = getClass().getResource("ssright/ultimate"+ctr+".png");
						}						
						try{
							image = ImageIO.read(resource);
						}
	...
	public void ultimatesAnimation(){
		Thread thread1 = new Thread(new Runnable(){
			public void run(){
				for(int ctr = 0; ctr < 4; ctr++){
					try {
						if(ctr==3){
							...
							resource = getClass().getResource("ssleft/ultimates"+ctr+".png");
						}						
						try{
							image = ImageIO.read(resource);
						}
